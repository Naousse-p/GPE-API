const { event_create_personnal_service } = require("../../../src/controllers/event/services");
...
describe("event_create_personnal_service", () => {
    ...
    const datas = {
        ...
        location: "Room 101",
        sharedWithProfessors: ["valid-professor-id"]
    };
    ...
    it("should create a personal event successfully", async () => {
        ...
        const result = await event_create_personnal_service(datas, classId, req);
    ...
    it("should throw an error if the class is not found", async () => {
        ...
        await expect(event_create_personnal_service(datas, classId, req)).rejects.toEqual({
            code: 404,
